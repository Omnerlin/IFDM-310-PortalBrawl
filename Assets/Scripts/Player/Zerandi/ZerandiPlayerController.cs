...
public partial class ZerandiPlayerController : PlayerControl
{
    ...
    private StateMachine<ZerandiState> sMachine;
    ...
    private void Awake()
    {
        ...
        sMachine = new StateMachine<ZerandiState>(new WalkState(this, sources));
    ...
    private void UpdateReticleOrientation()
    {
        bool isAiming = true;
        float aimAngle = 0;
        ...
        if (aimAngle < -110 || aimAngle > 110)
        {
            ...
            //if (aimReticle.transform.localSc
        }
